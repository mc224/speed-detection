...
def create_video():
    image_folder = 'result_multiple'  # Use the folder
    video_name = 'multiple_circle.avi'
...
def object_detection():
    capture = cv2.VideoCapture("multiple_circle.avi")
    ...
    while capture.isOpened():
        ...
        if ret:
            ...
            #
            cv2.line(img_1, (164, 82), (290, 82), (255, 0, 0), 5)

            cv2.line(img_1, (1355, 82), (1500, 82), (255, 0, 0), 5)
